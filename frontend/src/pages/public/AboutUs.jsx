  ...
  return (
    <section className="bg-white py-12 px-4 md:px-10">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        {/* Image */}
        <img
          src="/vet.jpg" // make sure the image exists here
        ...
        {/* Text */}
        <div>
          <h3 className="text-3xl font-bold text-orange-700 mb-4">About VetConnect</h3>
          <p className="text-gray-700 text-lg leading-relaxed">
            VetConnect is dedicated to providing modern healthcare solutions for pet parents.
            From 24/7 online appointments to custom treatment plans and digital records, we make
            pet care simple, smart, and accessible. With our platform, you can book consultations,
            manage prescriptions, and track your pet’s health from anywhere.
          </p>
        </div>
      </div>
